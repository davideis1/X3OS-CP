...
void WifiSelectionActivity::onExit() {
  ...
  // (TinyRdrWebServerActivity) manages WiFi connection state. We just clean
...
void WifiSelectionActivity::attemptConnection() {
  ...
  // Set hostname so routers show "TinyRdr-AABBCCDDEEFF" instead of "esp32-XXXXXXXXXXXX"
  String mac = WiFi.macAddress();
  mac.replace(":", "");
  String hostname = "TinyRdr-" + mac;
