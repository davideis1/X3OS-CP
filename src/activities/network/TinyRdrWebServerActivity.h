...
#include "network/TinyRdrWebServer.h"
...
/**
 * TinyRdrWebServerActivity is the entry point for file transfer functionality.
 * It:
 ...
 * - Starts the TinyRdrWebServer when connected
 * - Handles client requests in its loop() function
 * - Cleans up the server and shuts down WiFi on exit
 */
class TinyRdrWebServerActivity final : public Activity {
  ...
  std::unique_ptr<TinyRdrWebServer> webServer;
 ...
 public:
  explicit TinyRdrWebServerActivity(GfxRenderer& renderer, MappedInputManager& mappedInput)
      : Activity("TinyRdrWebServer", renderer, mappedInput) {}
