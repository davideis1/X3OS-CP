#include "TinyRdrWebServerActivity.h"
...
constexpr const char* AP_SSID = "TinyRdr";
constexpr const char* AP_PASSWORD = nullptr;  // Open network for ease of use
constexpr const char* AP_HOSTNAME = "tinyrdr";
...
void TinyRdrWebServerActivity::onEnter() {
  Activity::onEnter();
...
void TinyRdrWebServerActivity::onExit() {
  Activity::onExit();
...
void TinyRdrWebServerActivity::onNetworkModeSelected(const NetworkMode mode) {
...
void TinyRdrWebServerActivity::onWifiSelectionComplete(const bool connected) {
...
void TinyRdrWebServerActivity::startAccessPoint() {
...
void TinyRdrWebServerActivity::startWebServer() {
  LOG_DBG("WEBACT", "Starting web server...");

  // Create the web server instance
  webServer.reset(new TinyRdrWebServer());
  webServer->begin();
...
void TinyRdrWebServerActivity::loop() {
...
void TinyRdrWebServerActivity::render(RenderLock&&) {
...
void TinyRdrWebServerActivity::renderServerRunning() const {
  const auto& metrics = UITheme::getInstance().getMetrics();
  const auto pageWidth = renderer.getScreenWidth();
...
void TinyRdrWebServerActivity::renderWifiIndicator(int subHeaderTop) const {
