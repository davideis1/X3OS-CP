...
void ButtonRemapActivity::render(RenderLock&&) {
  ...
  GUI.drawButtonHints(renderer, labelForHardware(TinyRdrSettings::FRONT_HW_BACK),
                      labelForHardware(TinyRdrSettings::FRONT_HW_CONFIRM),
                      labelForHardware(TinyRdrSettings::FRONT_HW_LEFT),
                      labelForHardware(TinyRdrSettings::FRONT_HW_RIGHT));
...
const char* ButtonRemapActivity::getHardwareName(const uint8_t buttonIndex) const {
  switch (buttonIndex) {
    case TinyRdrSettings::FRONT_HW_BACK:
      return tr(STR_HW_BACK_LABEL);
    case TinyRdrSettings::FRONT_HW_CONFIRM:
      return tr(STR_HW_CONFIRM_LABEL);
    case TinyRdrSettings::FRONT_HW_LEFT:
      return tr(STR_HW_LEFT_LABEL);
    case TinyRdrSettings::FRONT_HW_RIGHT:
