/* TinyRdr only needs miniz's low-level streaming inflate (tinfl). The
...
// tinyrdr_ (NOT freeink_) so a future branch that links FreeInkBook's
// identically-renamed copy does not collide.
#define tinfl_decompress tinyrdr_tinfl_decompress
#define tinfl_decompress_mem_to_heap tinyrdr_tinfl_decompress_mem_to_heap
#define tinfl_decompress_mem_to_mem tinyrdr_tinfl_decompress_mem_to_mem
#define tinfl_decompress_mem_to_callback tinyrdr_tinfl_decompress_mem_to_callback
#define mz_crc32 tinyrdr_mz_crc32
#define mz_adler32 tinyrdr_mz_adler32
#define mz_free tinyrdr_mz_free
